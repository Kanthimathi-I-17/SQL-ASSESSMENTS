...
CREATE TABLE `students_1` (
  ...
  `student_sur_name` varchar(50) DEFAULT NULL,
  `student_bod` date DEFAULT NULL,
  `student_gender` char(10) DEFAULT NULL,
  `student_class` varchar(50) DEFAULT NULL,
  `student_point` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`student_id`),
  KEY `index_students_1_student_name` (`student_name`)
