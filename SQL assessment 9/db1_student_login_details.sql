...
CREATE TABLE `student_login_details` (
  ...
  KEY `std_id` (`std_id`),
  CONSTRAINT `student_login_details_ibfk_1` FOREIGN KEY (`std_id`) REFERENCES `student_master` (`std_id`)
...
INSERT INTO `student_login_details` VALUES ('ST-1789','09:36:41'),('ST-1790','09:36:41'),('ST-1791','09:36:41');
