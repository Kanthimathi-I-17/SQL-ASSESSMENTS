...
CREATE TABLE `log_emp_details` (
  ...
  KEY `emp_id` (`emp_id`),
  CONSTRAINT `log_emp_details_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `emp_details` (`emp_id`)
...
INSERT INTO `log_emp_details` VALUES ('EM-987771',40000.9,'2022-10-15 15:37:37');
